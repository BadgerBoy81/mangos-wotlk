...
PEXCEPTION_POINTERS pExceptionInfo)
{
    ...
    if (m_hDumpFile)
    {
        ...
        if (pExceptionInfo->ExceptionRecord->ExceptionCode == 0xC0000420L && pExceptionInfo->ExceptionRecord->NumberParameters > 0)
        {
...
PEXCEPTION_POINTERS pExceptionInfo)
{
    __try
    {
        ...
        if (pExceptionRecord->ExceptionCode == 0xC0000420L && pExceptionRecord->NumberParameters >= 2)
        {
