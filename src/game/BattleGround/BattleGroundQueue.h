...
class BattleGroundQueue
{
    ...
    public:
        ...
        void BuildBattleGroundListPacket(WorldPacket& data, ObjectGuid guid, uint32 playerLevel, BattleGroundTypeId bgTypeId, uint8 fromWhere, bool hasWonRandomBg) const;
    private:
